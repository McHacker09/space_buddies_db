...
CREATE TABLE public.moon (
    ...
    age_in_million_of_years numeric(6,4),
    description text,
    has_life boolean,
    size_in_km integer,
    name character varying(30) NOT NULL,
...
INSERT INTO public.galaxy VALUES (1, 10010.00, 'Andromeda Time', true, 1000, 'Andromeda', 2500000, 'spiral');
...
--
-- Name: galaxy shape; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.galaxy
    ADD CONSTRAINT shape UNIQUE (shape);
